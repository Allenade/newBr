        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-12">
          <div>
            ...
            <p className="text-gray-400 mb-6 text-sm">
              ...
              and Multi-level Marketing? Start Today at Pi-minnet!!
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex text-gray-400">
                ...
                <span>support@pi-minnet.com</span>
              </li>
              <li className="flex text-gray-400">
          ...
          <div>
            <h3 className="text-lg font-bold mb-6">About Pi-minnet</h3>
            <p className="text-gray-400 mb-6">
              Pi-minnet is totally different from its competitors trying to
        ...
        <div className="border-t border-gray-800 pt-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-500 text-sm mb-4 md:mb-0">
              © {new Date().getFullYear()} Pi-minnet. All rights reserved.
            </p>
